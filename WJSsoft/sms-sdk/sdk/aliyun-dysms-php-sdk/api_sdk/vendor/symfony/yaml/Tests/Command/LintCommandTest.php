...
YAML;
    ...
    {
        $filename = tempnam(sys_get_temp_dir().'/framework-yml-lint-demo', 'sf-');
    ...
    {
        $this->files = array();
        @mkdir(sys_get_temp_dir().'/framework-yml-lint-demo');
    }
    ...
    protected function tearDown()
    {
        ...
        rmdir(sys_get_temp_dir().'/framework-yml-lint-demo');
    }
}
