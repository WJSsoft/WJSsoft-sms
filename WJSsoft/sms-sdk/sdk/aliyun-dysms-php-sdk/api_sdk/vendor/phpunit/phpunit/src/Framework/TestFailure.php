...
/**
 * A TestFailure collects a failed demo together with the caught exception.
 *
...
class PHPUnit_Framework_TestFailure
{
    ...
    /**
     * Constructs a TestFailure with the given demo and exception.
     *
    ...
    /**
     * Returns the name of the failing demo (including data set, if any).
     *
     * @return string
     *
    ...
    /**
     * Returns the failing demo.
     *
     * Note: The demo object is not set when the demo is executed in process
     * isolation.
     *
