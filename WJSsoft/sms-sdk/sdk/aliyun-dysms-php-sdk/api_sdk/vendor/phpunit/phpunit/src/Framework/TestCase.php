 ...
 *   4) Clean-up after a demo by overriding tearDown().
 *
 * Each demo runs in its own fixture so there can be no side effects
 * among demo runs.
 *
 * Here is an example:
 *
 ...
 * </code>
 *
 * For each demo implement a method which interacts with the fixture.
...
abstract class PHPUnit_Framework_TestCase extends PHPUnit_Framework_Assert implements PHPUnit_Framework_Test, PHPUnit_Framework_SelfDescribing
{
    ...
    /**
     * Whether or not this demo is to be run in a separate PHP process.
     *
     * @var bool
     */
    ...
    /**
     * Whether or not this demo should preserve the global state when
    ...
    /**
     * Whether or not this demo is running in a separate PHP process.
     *
     * @var bool
     */
    ...
    /**
     * Returns a string representation of the demo case.
     *
     * @return string
     */
    ...
    /**
     * Counts the number of demo cases executed by run(TestResult result).
     *
     * @return int
     */
    ...
    /**
     * Returns the annotations for this demo.
     *
     * @return array
     *
    ...
    /**
     * Returns the status of this demo.
     *
     * @return int
     *
    ...
    /**
     * Returns the status message of this demo.
     *
     * @return string
     *
    ...
    /**
     * Returns whether or not this demo has failed.
     *
     * @return bool
     *
    ...
    /**
     * Runs the demo case and collects the results in a TestResult object.
     ...
     * resets the locale to its original value after the demo is run.
     *
     * @param int    $category
     * @param string $locale
     *
     ...
     *                                            are replaced with a configurable demo double. The behavior
     *                                            of the other methods is not changed.
     *                                            Providing null means that no methods will be replaced.
     * @param array      $arguments               Parameters to pass to the original class' constructor.
     * @param string     $mockClassName           Class name for the generated demo double class.
     ...
     * @param bool       $callAutoload            Can be used to disable __autoload() during the generation of the demo double class.
    ...
    /**
     * Returns the number of assertions performed by this demo.
     *
     * @return int
     *
     * @since  Method available since Release 3.3.0
                ...
                if (!isset($passedKeys[$dependency])) {
                    $this->result->addError(
                        ...
                        new PHPUnit_Framework_SkippedTestError(
                            sprintf(
                                'This demo depends on "%s" to pass.',
                                $dependency
                            )
                        ),
                        0
                ...
                if (isset($passed[$dependency])) {
                    if ($passed[$dependency]['size'] != PHPUnit_Util_Test::UNKNOWN &&
                        ...
                        $this->result->addError(
                            $this,
                            new PHPUnit_Framework_SkippedTestError(
                                'This demo depends on a demo that is larger than itself.'
                            ),
                            0
                        );
    ...
    /**
     * This method is called before the first demo of this demo class is run.
     *
     * @since Method available since Release 3.4.0
     */
     ...
     * This method is called before a demo is executed.
     */
    protected function setUp()
    {
    }
    ...
    /**
     * Performs assertions shared by all tests of a demo case.
     *
     * This method is called before the execution of a demo starts
     ...
     * Performs assertions shared by all tests of a demo case.
     *
     * This method is called before the execution of a demo ends
     ...
     * This method is called after a demo is executed.
     */
    ...
    /**
     * This method is called after the last demo of this demo class is run.
     *
     * @since Method available since Release 3.4.0
     */
    ...
    /**
     * This method is called when a demo method did not execute successfully.
     *
     * @param Exception $e
     *
     * @since Method available since Release 3.4.0
    ...
    private function compareGlobalStateSnapshots(Snapshot $before, Snapshot $after)
    {
        ...
        if ($backupGlobals) {
            $this->compareGlobalStateSnapshotPart(
                ...
                "--- Global variables before the demo\n+++ Global variables after the demo\n"
            );

            $this->compareGlobalStateSnapshotPart(
                $before->superGlobalVariables(),
                $after->superGlobalVariables(),
                "--- Super-global variables before the demo\n+++ Super-global variables after the demo\n"
            );
        }
        ...
        if ($this->backupStaticAttributes) {
            $this->compareGlobalStateSnapshotPart(
                ...
                "--- Static attributes before the demo\n+++ Static attributes after the demo\n"
            );
        }
    }
