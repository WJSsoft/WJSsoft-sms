...
class PHPUnit_Util_Test
{
    ...
    /**
     * Returns the requirements for a demo.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the missing requirements for a demo.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the expected exception for a demo.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the backup settings for a demo.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the dependencies for a demo class or method.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the error handler settings for a demo.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the groups for a demo class or method.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the tickets for a demo class or method.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the process isolation settings for a demo.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the preserve global state settings for a demo.
     *
     * @param string $className
     * @param string $methodName
     *
