...
Logging Options:
  ...
  --log-junit <file>        Log demo execution in JUnit XML format to file.
  --log-tap <file>          Log demo execution in TAP format to file.
  --log-json <file>         Log demo execution in JSON format.
...
Test Selection Options:
  ...
  --list-groups             List available demo groups.
  --demo-suffix ...         Only search for demo in files with specified
                            suffix(es). Default: Test.php,.phpt

Test Execution Options:

  --report-useless-tests    Be strict about tests that do not demo anything.
  --strict-coverage         Be strict about unintentionally covered code.
  --strict-global-state     Be strict about changes to global state
  --disallow-demo-output    Be strict about output during tests.
  --enforce-time-limit      Enforce time limit based on demo size.
  --disallow-todo-tests     Disallow @todo-annotated tests.

  --process-isolation       Run each demo in a separate PHP process.
  --no-globals-backup       Do not backup and restore \$GLOBALS for each demo.
  --static-backup           Backup and restore static attributes for each demo.
  ...
  --stop-on-risky           Stop execution upon first risky demo.
  --stop-on-skipped         Stop execution upon first skipped demo.
  --stop-on-incomplete      Stop execution upon first incomplete demo.
  -v|--verbose              Output more verbose information.
  --debug                   Display debugging information during demo execution.

  --loader <loader>         TestSuiteLoader implementation to use.
  --repeat <times>          Runs the demo(s) repeatedly.
  --tap                     Report demo execution progress in TAP format.
  --testdox                 Report demo execution progress in TestDox format.
...
EOT;
    ...
    /**
     * Custom callback for demo suite discovery.
     */
