...
class PHPUnit_TextUI_ResultPrinter extends PHPUnit_Util_Printer implements PHPUnit_Framework_TestListener
{
    ...
    {
        $this->printDefects($result->notImplemented(), 'incomplete demo');
    }
    ...
    {
        $this->printDefects($result->risky(), 'risky demo');
    }
    ...
    {
        $this->printDefects($result->skipped(), 'skipped demo');
    }
