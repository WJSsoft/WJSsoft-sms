...
/**
 * A TestResult collects the results of executing a demo case.
 *
...
class PHPUnit_Framework_TestResult implements Countable
{
    ...
    /**
     * Informs the result that a demo will be started.
     *
     * @param PHPUnit_Framework_Test $test
     */
    ...
    /**
     * Informs the result that a demo was completed.
     *
     * @param PHPUnit_Framework_Test $test
     * @param float                  $time
     */
    ...
    /**
     * Returns true if no risky demo occurred.
     *
     * @return bool
     *
    ...
    /**
     * Returns true if no incomplete demo occurred.
     *
     * @return bool
     */
    ...
    /**
     * Returns true if no demo has been skipped.
     *
     * @return bool
     *
     * @since  Method available since Release 3.0.0
    ...
    public function run(PHPUnit_Framework_Test $test)
    {
        ...
        if ($collectCodeCoverage) {
            // We need to blacklist demo source files when no whitelist is used.
            ...
            try {
                ...
                $this->addFailure(
                    ...
                    new PHPUnit_Framework_UnintentionallyCoveredCodeError(
                        'This demo executed code that is not listed as code to be covered or used:' .
        ...
        if ($error === true) {
            ...
            $this->addFailure(
                ...
                new PHPUnit_Framework_RiskyTestError(
                    'This demo did not perform any assertions'
                ),
                $time
            );
    ...
    /**
     * Checks whether the demo run should stop.
     *
     * @return bool
     */
    ...
    /**
     * Marks that the demo run should stop.
     */
    ...
    /**
     * Returns whether the entire demo was successful or not.
     *
     * @return bool
     */
